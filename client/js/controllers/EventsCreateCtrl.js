...
var CTRL_NAME = 'eventsCreateCtrl';
...
eventsCreateCtrl.$inject = ['$scope', '$http', '$upload', '$location'];
function eventsCreateCtrl($scope, $http, $upload, $location) {
...
module.exports = function(name) {
	angular.module(name)
	.config(conf)
	.controller(CTRL_NAME, eventsCreateCtrl);
