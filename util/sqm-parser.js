...
module.exports = exports = function parseSqmString (sqmFileStr, callback) {
  if (typeof sqmFileStr !== 'string') throw new Error('parseSqmString expects a read file as string')
  ...
  try {
    ...
    Object.keys(groups).forEach(function (groupKey) {
      ...
      if (!group.Vehicles || !isAllowedSide(group.side)) return

      var add = false
      var side = group.side
      var tempGrp = {
        name: 'Group '.concat(idx++),
        units: []
      }
